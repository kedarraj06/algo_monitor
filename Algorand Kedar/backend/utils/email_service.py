...
# Gmail SMTP settings (works with any Gmail App Password)
...
def send_alert_email(to_email: str, contract_address: str, txn_id: str,
    ...
    if not EMAIL_USER or not EMAIL_PASS:
        logger.warning("[Email] EMAIL_USER or EMAIL_PASS not set. Skipping email.")
        return False
    ...
    try:
        ...
        msg["Subject"] = subject
        msg["From"] = f"AlgoShield AI <{EMAIL_USER}>"
        msg["To"] = to_email
        ...
        logger.error(
            ...
            "Ensure EMAIL_USER and EMAIL_PASS (App Password) are correct."
        )
        return False
