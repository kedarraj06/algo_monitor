...
async def fetch_contract_transactions(contract_address: str, min_round: int = 0) -> list:
    """
    Fetches transactions for a given Algorand contract address (58-char account or numeric app ID).
    ...
    if contract_address_stripped.isdigit():
        ...
        params = {"limit": 100, "application-id": int(contract_address_stripped)}
    else:
